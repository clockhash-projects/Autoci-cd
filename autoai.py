...
def parse():
    ...
    with open('clockhash.yml', 'r') as f:
        ...
        if data['repo'] == 'github':
             ...
             token = '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'
             g = Github(token)
        ...
        if data['repo'] == 'gitlab':
             ...
             gl = gitlab.Gitlab('https://gitlab.com/', private_token='glpat-VurK1gzH-6W8yFqxW4cH')
             project_id = 45460074
             variable_key = 'KUBE'
